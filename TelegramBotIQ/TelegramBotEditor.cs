...
Пароль: {userDB.GetPass()}");
        ...
        {
            //var webProxy = new WebProxy(Host: "https://www.themoviedb.org", Port: 8080)
            //{
            //    // Credentials if needed:
            //    Credentials = new NetworkCredential("ed4kod", "edgar979")
            //};
            //var httpClient = new HttpClient(
            //    new HttpClientHandler { Proxy = webProxy, UseProxy = true }
            //);

            //var botClient = new TelegramBotClient("1354258883:AAG4sK8gh1e9zFuEp1mzID1Le169lX2xRbw", httpClient);
